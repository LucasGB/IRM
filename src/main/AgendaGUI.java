...
public class AgendaGUI extends javax.swing.JFrame {
    ...
    private AppointmentGUI dialogCompromisso;
    ...
    public AgendaGUI() {
        initComponents();
        dialogCompromisso = new AppointmentGUI(this, true);
    ...
    private void buttonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAdicionarActionPerformed
        ...
        if (dialogCompromisso.getActionExecuted() == AppointmentGUI.ActionType.ADD) {

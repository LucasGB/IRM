 ...
 * @author rodrigo
 */
public class AppointmentGUI extends javax.swing.JDialog {
     ...
     */
    public AppointmentGUI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public Appointment obtemDados() {
        Appointment appointment =  new Appointment(0, textFieldData.getText(), textFieldHora.getText(),
        textFieldAssunto.getText(), textFieldDescricao.getText(), textFieldNotificacao.getText().equals("SIM"));
        this.limparCampos();
        return appointment;
    }
    
    public void recuperaDados(Appointment appointment){
        buttonAdicionar.setText("Alterar");
        setTitle("Alterar Compromisso");
        
        textFieldData.setText(appointment.getDate());
        textFieldHora.setText(appointment.getTime());
        textFieldAssunto.setText(appointment.getTopic());
        textFieldDescricao.setText(appointment.getDescription());

        if(appointment.getNotification()){
            textFieldNotificacao.setText("SIM");
        }
        else{
            textFieldNotificacao.setText("NÃO");
        }
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AppointmentGUI dialog = new AppointmentGUI(new javax.swing.JFrame(), true);
